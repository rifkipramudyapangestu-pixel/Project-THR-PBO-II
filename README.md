...
Analisis sistem ini bertujuan untuk mengidentifikasi komponen-komponen utama dalam Sistem Pengelolaan Jadwal Presentasi Kelompok menggunakan pendekatan berorientasi objek. Fokus utama adalah pada identifikasi kelas, atribut, metode, penerapan konsep inheritance, serta hubungan antar kelas.
...
1. Pengguna – Mahasiswa Hubungan inheritance, di mana Mahasiswa mewarisi atribut dan method dari Pengguna.
2. Pengguna – Dosen Hubungan inheritance, di mana Dosen juga mewarisi atribut dan method dari Pengguna.
3. Kelompok – Mahasiswa Hubungan aggregation, di mana satu kelompok terdiri dari beberapa mahasiswa sebagai anggota.
4. Presentasi – Kelompok Hubungan association, karena setiap presentasi dilakukan oleh satu kelompok.
5. Presentasi – Dosen Hubungan association, karena setiap presentasi dinilai oleh seorang dosen.
6. Dosen – Presentasi Hubungan one-to-many, di mana satu dosen dapat mengatur dan menilai beberapa presentasi.
